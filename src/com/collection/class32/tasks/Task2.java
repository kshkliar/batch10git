...
// If we want something to store in sorted from we use TreeMap
        //getting the keys only:
        for (String key : countries.keySet()
        ) {
            System.out.println(key);
           /* if(key.length()>2){
                countries.remove(key); not recommended  it can change the size of Set never try to do that
            }*/

        }   //сначала печатают  countries.keySet() потом iterator(); потом помещают в Iterator<String> iterator
        //first get the collection than call method to iterate
        ...
        System.out.println("=======================================================");
        //you can use introduce local variable it will save your time
