...
- рассказывать о себе.
Люди делятсяа н 3 типа (разные классы):
...
3 (Реалисты) Если возраст собеседника меньше или равен или больше не
...
потом второй с третьим, третий со вторым и т.д.
...
abstract public class Human {
    ...
    public static final String[] NAMES =
            {"Александр", "Андрей","Анастасия","Ирина"};

    public Human(int age) {
        int indexName = RANDOM.nextInt(NAMES.length);//получаем индекс
    ...
    abstract String greet(Human human);
}
