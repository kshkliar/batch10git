package replit.Repl177a;
/*# Interface
**** Follow Steps Carefully**
Step 1: Create Interface as Outputs
Step 2: Create one method with below details
- First Methods: return type void, method name display, parameters -> result
...
interface Outputs{
    ...
    public void display(double rusult);
}
...
class Main implements Functions {
    ...
    @Override
    public void display(double rusult) {
        System.out.println("Result is " + rusult);
    }
