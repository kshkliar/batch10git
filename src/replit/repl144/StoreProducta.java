...
public class StoreProducta {
    ...
    public StoreProducta(String lable, double price, String category,
    ...
    public StoreProducta(String lable, double price, int stock) {
        this.lable = lable;
        this.price = price;
        this.stock = stock;
    }

    public StoreProducta(String lable, double price) {
        this.lable = lable;
        this.price = price;
    }
