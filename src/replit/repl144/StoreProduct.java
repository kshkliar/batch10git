...
Create below instance variables. (Choose proper datatype and naming convention for
variable )
...
* Second constructor with all parameters except category and hasExpiration (category
defaults to "misc", hasExpiration defaults to false inside constructor)
